...
用法：python webcam_monitor.py [--target person] [--interval 5] [--model yolo6n]
"""
...
def monitor(target: str = "person", interval: int = 5, model_name: str = "yolo6n"):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="YOLO6 Webcam 持續監控")
