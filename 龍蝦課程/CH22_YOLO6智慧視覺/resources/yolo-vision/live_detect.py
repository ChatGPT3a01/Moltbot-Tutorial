...
用法：python live_detect.py [--model yolo6n]
按 Q 鍵退出。
"""
...
def live_detect(model_name: str = "yolo6n"):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="YOLO6 即時偵測視窗")
